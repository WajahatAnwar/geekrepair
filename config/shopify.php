...
return [
    ...
    */
    ...
    'scope' => ["read_products", "write_script_tags", "write_products", "read_themes", "write_themes", "read_customers", "write_customers", "read_orders", "write_orders", "read_draft_orders", "write_draft_orders"],
