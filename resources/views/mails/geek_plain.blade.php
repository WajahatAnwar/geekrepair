...
@for ($i = 0; $i < $counting; $i++) <h2><strong>{{ $testVarOne[$i] }}</strong></h2>
    @endfor

    <p>Voor de installatiehandleiding en software van je producten kan je terecht op onze website <a href="www.ninjacode.nl">www.ninjacode.nl</a> of klik <a href="www.ninjacode.nl/pages/downloads">hier</a> indien je een installatie dvd hebt aangeschaft dan gaat deze dezelfde dag (indien voor 17:00 besteld) nog mee met de post</p>

    <p>Graag zien we je spoedig terug bij Geekrepair. Indien je nog vragen hebt kan je altijd een mail sturen naar <a href="#">info@ninjacode.nl</a></p>
